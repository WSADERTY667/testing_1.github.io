...
begin.addEventListener("click", function () {
  (count.style.display = "flex"), (beginning.style.display = "none");
});

const questions = [
  {
    question:
      "Укажите вариант ответа, в котором во всех словах одного ряда пропущена одна и та же буква.",
    answers: [
      "г…ревать, р…внина, крыж…вник",
      "укр...титель (тигров), благосл...вить, симп...тичный",
      "ц...ничный (человек), ц...ркачи, ц...тата",
      "бл...стеть, сц...пление, ум...ротворённый"
    ],
    correctAnswers: [2]
  },
  {
    question:
      "Укажите вариант ответа, в котором во всех словах одного ряда пропущена одна и та же буква.",
    answers: [
      "трёх…уровневый, вз…есться, необ…ятный",
      "бе...радостный, ра...жечь, ни...вергнуть",
      "пр...ходящий (момент), пр...чудливый, пр...емник (традиций)",
      "вз...мающий, пред...стория, без...мянный"
    ],
    correctAnswers: [1]
  },
  {
  ...
  },
  {
    question:
      "Укажите вариант ответа, в котором во всех словах одного ряда пропущена одна и та же буква.",
    answers: [
      "(директор) назнача...т, независ...мая",
      "(друзья) тороп...ятся, (слова) сыпл...тся",
      "отма...вшийся, (звуки) донос...ят",
      "осып...анный, рассерж...енный"
    ],
    correctAnswers: [2]
  },
  {
    question:
      "Укажите вариант ответа, в котором НЕ с выделенным словом пишется РАЗДЕЛЬНО.",
    answers: [
      "мое решение было далеко (НЕ)ЛЁГКИМ",
      "я почувствовала себя (НЕ)ХОРОШО",
      "(НЕ)ЗВАННЫЙ гость хуже татарина",
      "У Маши был крайне (НЕ)ЗДОРОВЫЙ вид"
    ],
    correctAnswers: [0]
  },
  {
    question:
      "Определите предложение, в котором выделенное слово пишется СЛИТНО.",
    answers: [
      "я написал ТАК(ЖЕ), как ты мне предложил",
      "прохожий зашел ЗА(ТО) здание",
      "И(ТАК) мы общались целый месяц",
      "я ТО(ЖЕ) хочу пойти в кино"
    ],
    correctAnswers: [3]
  },
  {
    question:
      "Укажите вариант ответа, в котором НЕВЕРНО выделена буква, обозначающая ударный гласный звук.",
    answers: ["Иконопись", "сливОвый", "пОгнутый", "грУшевый"],
    correctAnswers: [1]
  }
];
...
document.getElementById("next-button").addEventListener("click", function () {
  ...
  if (
    userAnswers[currentQuestion].sort().join(",") ===
...
document.getElementById("next-button").addEventListener("click", function () {
  if (currentQuestion >= questions.length - 1) {
    ...
    document.getElementById("time").innerText =
      "Выполнено за " + formatTime(seconds);
  }
});
